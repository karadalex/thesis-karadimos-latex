...
\nomenclature{$O_{F}, O_{Fi}$}{A generic origin point of fulcrum reference frame and origin point of fulcrum reference frame $\lbrace i \rbrace$ and estimated origin point of fulcrum reference frame $\lbrace i \rbrace$ respectively}
\nomenclature{$\tilde{O}_{Fi}$}{Estimated origin point of fulcrum reference frame $\lbrace i \rbrace$}