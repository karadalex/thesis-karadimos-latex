...
Linear Segments with Parabolic Blends or LSPB. The equations of motions are studied in 3 intervals $[t_i, t_a], [t_a, t_d]$ and $[td, t_{i+1}$ where $t_a = t_i + τ$ and $t_d = t_{i+1} - τ$ where $τ$ is 
