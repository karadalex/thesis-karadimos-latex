...
taskspace which will then be transformed via the fulcrum transformation to a trajectory that the robotic arm can execute. Cubic spline equations are presented in more detail at \ref{section:cubic-spline} and the generated trajectories 
of this experiment can be seen in figure \ref{robot-planner3c-cubic-spline}.
...
The goal of this experiment is to generate a B-Spline trajectory inside the surgical
...
of this experiment can be seen in figure \ref{robot-planner3d-bezier-spline}.
